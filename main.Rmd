...
### Other remotely derived info

Mapped versus actual burned area within wildfire perimeters: Characterizing
the unburned (2012)

using Landsat

Jonathan Kane paper: We characterized
...
unburned from dNBR was 37% for Yosemite, 17% for Glacier, and 14% for Yukon-Charley.
