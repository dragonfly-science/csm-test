...
LiDAR plot metrics derived from the point clouds can be grouped into four categories: 

1) descriptive
2) height percentile (canopy height distributions within the plot) estimator for carbon and AGB (Lim & Treitz, 2004; Patenaude et al., 2004)
3) intensity
4) canopy cover. Height percentiles, which describe the canopy height distributions within the plot, were suggested to be an estimator of AGB and its carbon content31,32
