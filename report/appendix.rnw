...
%%     \addlinespace
%% <<r1, echo=FALSE>>=
%% sentinelbands <- read.csv(file="../tables/sentinel2.csv", header = TRUE)
%% require(xtable)
%% options(
%%   xtable.include.rownames = FALSE,
%%   xtable.include.colnames = FALSE,
%%   xtable.only.contents = TRUE,
%%   xtable.floating = FALSE,
%%   xtable.hline.after = -1
%%   )
%% print(xtable(sentinelbands))
%% @
%%   \end{tabular}
%% \end{table}
%% \end{small}
...
%%     \addlinespace
%% <<r2, echo=FALSE>>=
%% vegindices <- read.csv(file="../tables/vegindices.csv", header = TRUE)
%% print(xtable(vegindices))
%% @
%%   \end{tabular}
%% \end{tiny}
%% \end{table}
