...
For the purposes of our project, we are levergaing GDAL for all our important raster processing tasks including:
\begin{itemize}
...
Section about PostGIS/PostgreSQL \
