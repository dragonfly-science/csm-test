...
This report provides an overview of the datasets used to develop the CHM test case, documenting the proof of concept.   Detailed documentation for geospatial processes, machine-learning concepts and data ingestions via Amazon Web Services (AWS) that were part of this project are available on the linked repositories.
