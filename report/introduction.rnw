...
The following section provides a detailed overview of the literature review and methodologies considered. We do not anticipate to use all of the datasets mentioned, but where applicable provide reasons for our selected layers.
...
\textbf{Common LiDAR point metrics}
...
\textbf{Upscaling LiDAR with Sentinel-2}
...
\textbf{Upscaling LiDAR with GeoEye-1}
...
\textbf{Problems with field data} 
...
\textbf{Normalized Burn Ratio (NBR) for LandSat timeseries analysis}
...
\textbf{Pre-processing of Landsat data}
...
\textbf{Timeseries analysis for Landsat imagery}
...
\textbf{NOAA-AVHRR, MODIS, ASTER, Quickbird, IKONOS}
