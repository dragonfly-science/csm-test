...
fine-scale land-cover model capable of detecting ``tree-approximate objects.''

%The potential of expanding this platform to the entirety of the State of
%California, United States has prompted in expanding the scope of Vibrant Planet's prototype has been
%prompted by the groundbreaking nature of the data-informed decision support
%the platform can potentially provide to decision makers.
%
%Vibrant Planet has received interest from decision makers and funders about the
%potential of the platform to cover the entirety of the State of
%California in United States. Interest in expanding the scope of Vibrant Planet's prototype has been
%prompted by the groundbreaking nature of the data-informed decision support
%the platform can potentially provide to decision makers.
%
